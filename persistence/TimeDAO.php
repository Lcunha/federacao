...
class TimeDAO{
	...
	*/
	...
	/*
		The method is responsibility by to list all registers in database table of type Team.
	*/
	...
	/*
		The method is responsibility by to list all registers in database table of type Player.
	*/
	...
	/*
		The method is responsibility by to list all registers im database table through type of campionship data and team.
	*/
