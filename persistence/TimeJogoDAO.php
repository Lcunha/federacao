	...
	*/
	public function listarTodos(){
            ...
            while($registro = $resultado->FetchNextObject()){
                ...
                $dadosTimeJogo->__constructOverload($registro->TIME_ID_TIME, 
	...
	*/
	public function inserir(TimeJogo $dadosTimeJogo){
            $sql = "INSERT INTO jogo_time (jogo_id_jogo, time_id_time) 
                    VALUES ('{$dadosTimeJogo->__getIdJogo()}', 
                            '{$dadosTimeJogo->__getIdTime()}')";
	...
	*/
	public function atualizar(TimeJogo $dadosTimeJogo){
            $sql = "UPDATE jogo_time 
                SET jogo_id_jogo = '{$dadosTimeJogo->__getIdJogo()}',
