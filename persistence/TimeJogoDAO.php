...
class TimeJogoDAO{
	...
	*/
	public function inserir(TimeJogo $dadosTimeJogo){
		$sql = "INSERT INTO jogo_time (jogo_id_jogo,time_id_time) VALUES 
		('{$dadosTimeJogo->__getIdJogo()}', '{$dadosTimeJogo->__getIdTime()}')";
	...
	*/
	public function atualizar(TimeJogo $dadosTimeJogo){
		$sql = "UPDATE jogo_time SET jogo_id_jogo = '{$dadosTimeJogo->__getIdJogo()}',
		time_id_time = '{$dadosTimeJogo->__getIdTime()}' ";
		$this->conexao->banco->Execute($sql);
	}
